  ...
  return (
    <DefaultContainer breadcrumbs={['Home']}>
      ...
      <CustomTable
        ...
        itens={SaidaDoDia.map(refArray => (
          <StyledTableRow>
            <StyledTableCell>a</StyledTableCell>
            <StyledTableCell>{refArray.entity} </StyledTableCell>
            <StyledTableCell>{refArray.qunatityAliment} </StyledTableCell>
            <StyledTableCell>{refArray.status}</StyledTableCell>
            <StyledTableCell>{refArray.date}</StyledTableCell>
            <StyledTableCell>a</StyledTableCell>
          </StyledTableRow>
        ))}
